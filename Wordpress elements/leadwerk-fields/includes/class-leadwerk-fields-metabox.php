...
class Leadwerk_Fields_Metabox {
	...
	private static $options_sections = array(
		...
		array(
			'title' => 'Footer',
			'description' => 'Footer-Logo und optionale Social-Links. Tagline, Spalten-Ueberschriften und Copyright ueber Theme Strings (JSON).',
			'fields'  => array(
				'footer_logo'                 => array( 'label' => 'Footer-Logo', 'type' => 'image' ),
				'footer_social_instagram_url' => array( 'label' => 'Social: Instagram URL (optional)', 'type' => 'url' ),
				'footer_social_facebook_url'  => array( 'label' => 'Social: Facebook URL (optional)', 'type' => 'url' ),
			),
		),
		array(
