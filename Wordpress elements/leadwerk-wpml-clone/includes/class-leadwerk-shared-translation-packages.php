...
class Leadwerk_Shared_Translation_Packages {
	...
	protected static function get_registry() {
		$all_pages = self::get_all_francis_page_source_keys();
		...
		return array(
			array(
				...
				'keys'        => array(
					...
					'header_contact_cta_label' => 'Nav CTA (Probestunde)',
				),
	...
	/**
	 * Known Francis page source keys.
	 *
	 * @return array<int,string>
	 */
	protected static function get_all_francis_page_source_keys() {
		return array(
			'francis-index-v1',
			...
			'francis-kontakt-v1',
			'francis-danke-v1',
			'francis-impressum-v1',
			'francis-datenschutz-v1',
		);
	}

	/**
	 * @deprecated Use get_all_francis_page_source_keys().
	 * @return array<int,string>
	 */
	protected static function get_all_acm_page_source_keys() {
		return self::get_all_francis_page_source_keys();
	}
